...
<div style="display: flex; justify-content: space-between; align-items: center; gap: 5px; margin-top: 15px; margin-bottom: 20px;">
  ...
  <img src="/images/zehus3.png" alt="CAD 3" style="width: 30%; border-radius: 4px; border: 1px solid #eee;">
  <img src="/images/zehus4.png" alt="CAD 4" style="width: 30%; border-radius: 4px; border: 1px solid #eee;">
</div>
